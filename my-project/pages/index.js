    ...
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden">
      ...
      <header className="min-w-full text-gray-800 py-14 px-4 md:px-0">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          {/* Logo */}
          <Link href="#">
            <a className="font-kaushan text-xl md:text-3xl font-bold">
      ...
      <div className="h-full w-full container max-w-5xl mx-auto flex flex-col items-center pt-4">
        <div className="flex flex-col items-center max-w-4xl w-full">
          <Link href="/mint" passHref>
            <a className="mt-16 font-kaushan uppercase inline-flex items-center px-6 oy-2 text-sm sm:text-2xl md:text-3xl font-medium text-center rounded text-rose-500 hover:bg-rose-600 hover:text-white">
              Go to minting page
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full">
            ...
            <div className="flex flex-col md:items-start items-center justify-center text-center font-kaushan text-gray-800 px-4 md:px-0 py-10 mt-14">
              <h2 className="font-bold text-2xl md:text-4xl uppercase">
                About Complacent Monkeys Boat house
              </h2>

              <p className="mt-6 text-lg">
                {`Complacent Monkeys are a collection of 1000 lazy-ass NFTs living their best life on
                 the test-net blockchain. Can't afford a bored ape? Don't worry fren, we are here to help.`}
              </p>
            </div>
          </div>
        </div>
